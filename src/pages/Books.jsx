        ...
        return (
            ...
            <div className="container-fluid">
              <div className="row" style={{height: '50vh'}}>
                      ...
                      <div className="col">
                        <div className="card">
                          <div className="row no-gutters">
                            ...
                            <div className="col" style={{marginLeft: '5vh', marginTop: '1vh'}}>
                              <div className="card-block ml-1">
                                ...
                                <div>
                                  <Link to="/upload" style={{color: 'white'}}> 
                                    <Button type="button" className="btn btn-primary; ml-5" style={{borderRadius: 20, width: '15vh', color: 'white', backgroundColor: '#1f81DF'}}>Edit</Button>               
                                  </Link> 
                                </div>
                              </div>
                            </div>
                ...
                <div>
                  <Link to="/upload" style={{color: 'white'}}> 
                    <Button type="button" className="btn" style={{backgroundColor: '#1f81DF', color: 'white', borderRadius: 20, width: 200, height: 40, marginLeft: '170vh'}}>Add Book</Button>               
                  </Link> 
                </div>
