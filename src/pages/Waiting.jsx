              ...
              <div className="row no-gutters">
                ...
                <div className="col" style={{marginLeft: '3vh', marginTop: '1vh'}}>
                  <div className="card-block ml-1">
                    ...
                    <button type="button" className="btn btn-primary; ml-5" style={{borderRadius: 20, width: '15vh', color: 'white', backgroundColor: '#1f81DF'}}><a href="confirmation.html" style={{color: 'white'}}>Detail</a></button>
                  </div>
                </div>
              </div>
            </div>
